export default {
  ...
  settings: {
    ...
    clearDependenciesConfirm: 'Are you sure you want to clear all node_modules? They will be reinstalled on next build.',
    clearCacheConfirm: 'Are you sure you want to clear the build cache?',
    clearLogsConfirm: 'Are you sure you want to clear old logs?',
    dependenciesCleared: 'Dependencies cleared!',
    cacheCleared: 'Build cache cleared!',
    logsCleared: 'Logs cleared!',
    clearDependenciesFailed: 'Failed to clear dependencies',

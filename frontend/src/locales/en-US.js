export default {
  ...
  settings: {
    ...
    serverHostDesc: 'Hostname or IP for access URL (leave empty for auto-detection)',
    url: 'URL',
    lastDeploy: 'Last Deploy',
    ...
    frontendPortAvailable: 'Port available',
    frontendPortInUse: 'Port in use',
    frontendPortInvalid: 'Invalid port range',
    frontendPortCheckFailed: 'Port check failed',
    frontendSave: 'Save',
    frontendCancel: 'Cancel',
    frontendEditing: 'Editing',
    frontendApplyHint: 'Changes to port or server host require redeploy to take effect',
